...
import { fetchUserChats, fetchUserGroupChats } from '@/infrastructure/store/slices/chatSlice';
import UserSidebar from '@/presentation/components/user/UserSidebar';
import CreateGroupButton from '@/presentation/components/user/CreateGroupButton';
import CreateGroupModal from '@/presentation/components/chat/CreateGroupModal';
import { useNavigate, useSearchParams } from 'react-router-dom';
import { formatDistanceToNow } from 'date-fns';
import { useDisclosure } from '@mantine/hooks';
import GroupChatListSkeleton from '@/presentation/components/skeletons/GroupChatListSkeleton';
