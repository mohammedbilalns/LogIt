export enum HttpResponse {
  ...
  SUBSCRIPTION_NAME_EXISTS = 'A subscription plan with this name already exists.',
  SUBSCRIPTION_DETAILS_EXISTS = 'A subscription plan with these details (price, logs, articles) already exists.',
  SUBSCRIPTION_HAS_ACTIVE_USERS = 'Cannot modify subscription plan that has active users.',
