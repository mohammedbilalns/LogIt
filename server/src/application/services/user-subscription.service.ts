...
} from "../../domain/services/user-subscription.service.interface";
...
export class UserSubscriptionServiceImpl implements IUserSubscriptionService {
  ...
  async getUserCurrentPlan(
    ...
    import("../../domain/entities/subscription.entity").SubscriptionPlan
  > {
    const activeSubscription = await this.findActiveSubscriptionByUserId(
      userId
    );
